...
This table summarizes reviewer-visible concerns, author rebuttal coverage,
and post-rebuttal activity based solely on publicly accessible OpenReview logs.
